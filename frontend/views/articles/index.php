    ...
    <div class="main">
        ...
        <? if ($categories = ContentCategories::find()->limit(5)->all()) { ?>
            <div class="categories">
                <div class="owl-carousel news_category">
                    <div class="item">
                        <a class="<?= !$searchModel->category_id? "active":'';?>" href="<?= Url::to(['/articles']); ?>">Все</a>
                    </div>
                    <?php /** @var ContentCategories $category */
                    foreach ($categories as $category) { ?>
                        <div class="item">
                            <a href="<?= Url::to(['/articles', 'category_id' => $category->id]); ?>"
        ...
        <div class="thems">
            ...
            <?php foreach ($themes as $theme) { ?>
                <span class="<?= /** @var \frontend\models\ContentNewsSearch $searchModel */
            in_array($theme->id,$searchModel->themes)?"active":''?>" data-theme_id="<?= $theme->id;?>"><?= $theme->name;?></span>
            <? } ?>
        </div>
        <? } ?>
        <?
        if ($dataProvider->getModels()) { ?>
            <div class="row tabs">
                <?php /** @var \common\models\ContentArticles $new */
                        ...
                        <div class="tab">
                            ...
                            <div class="body_news">
                                ...
                                <div class="desc">
                                    ...
                                    <div class="bt">
                                        <a href="<?= Url::to(['/articles/view', 'id' => $new->id]); ?>"><img alt=""
